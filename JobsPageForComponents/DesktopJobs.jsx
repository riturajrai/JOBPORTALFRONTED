...
const DesktopJobs = () => {
  ...
  return (
    <div className="mt-[120px] min-h-screen bg-gray-50 font-inter flex flex-col hidden md:block">
      <header className="bg-white shadow-sm sticky top-0 left-0 z-10 border-b border-gray-100 w-full">
        ...
        <div className="flex rounded-md shadow-sm">
          <div className="relative flex-grow">
            <input
              ...
              className="block w-full pl-9 pr-9 py-2 text-sm border border-gray-300 rounded-l-md focus:ring-1 focus:ring-teal-500 focus:border-teal-500 placeholder-gray-400"
            />
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-teal-500 text-sm font-medium rounded-r-md bg-teal-500 text-white hover:bg-teal-600 focus:outline-none focus:ring-1 focus:ring-teal-500"
